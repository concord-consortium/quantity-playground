...
import { gray1, lightGray2 } from "../../utils/theme-utils";

export const IconOutputCard = () => {
  // Class names "background" and "border" are used to set the icon's color in the CSS.
  return (
    <svg width="60" height="24" viewBox="0 0 60 24" xmlns="http://www.w3.org/2000/svg">
      <g fill="none" fillRule="evenodd">
        <path d="M0 0h60v24H0z"/>
        <path fill={gray1} fillRule="nonzero" d="M43 11.25h8V7.5l9 4.5-9 4.5v-3.75h-8z"/>
        ...
        <circle fill={lightGray2} cx="42.75" cy="12" r="2.5"/>
        ...
        <path fill={gray1} fillRule="nonzero" d="m0 11.25 6.999-.001V7.5l9 4.5-9 4.5v-3.751L0 12.75z"/>
      </g>
    </svg>
  );
};
