import { connectionTarget, deleteEdgeButton, edge, edges, node, nodes, pane, selectedNodes, selectedEdges, deleteCardButton } from "../support/diagram-helpers";
...
context("Test Diagram interaction", () => {
  it("Interactions with the Diagram", () => {
    ...
    // FIXME: Keyboard delete is not registering in Cypress for unknown reasons
