context("Test Unused Variable Dialog and Delete Button", () => {
  ...
  describe("Delete Card Button", () => {
    it("Can delete a card and buttons are disabled properly", () => {
  ...
  describe("Unused Variable Dialog", () => {
    it("Unused variable dialog renders", () => {
    ...
    it("Can permanently remove variables", () => {
